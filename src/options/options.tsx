...
export const Options: React.FC = () => {
  ...
  const handleClearAll = async () => {
    if (
      confirm(
        'Are you sure you want to delete all captured content? This action cannot be undone.'
      )
    ) {
      try {
      ...
      <div className="options-content">
          ...
          <div className="section-content">
            <div className="setting-group">
              <label className="setting-label">
                <input
                  ...
                  onChange={e =>
                    updateAISettings({ enabled: e.target.checked })
                  }
                />
                <span>Enable AI processing</span>
              </label>
              <p className="setting-description">
                When enabled, captured content will be automatically categorized
                and tagged using AI.
              </p>
            </div>
            ...
            <div className="setting-group">
              ...
              <select
                ...
                onChange={e =>
                  updateAISettings({
                    provider: e.target.value as 'openai' | 'local',
                  })
                }
              ...
              <p className="setting-description">
                Local processing uses built-in heuristics. OpenAI provides more
                accurate results but requires an API key.
              </p>
            </div>
        ...
        <div className="settings-section">
          ...
          <div className="section-content">
            <div className="setting-group">
              ...
              />
              <p className="setting-description">
                Maximum number of entries to store. Older entries will be
                automatically removed when this limit is reached.
              </p>
            </div>
            ...
            <div className="setting-group">
              <label className="setting-label">
                <input
                  ...
                  onChange={e =>
                    updateStorageSettings({ autoCleanup: e.target.checked })
                  }
                />
                <span>Enable automatic cleanup</span>
              </label>
              <p className="setting-description">
                Automatically remove oldest entries when storage limit is
                reached.
                <strong> Disabled by default to keep all your records.</strong>
              </p>
            </div>
            ...
            <div className="setting-group">
              <div className="agreement-status">
                <div className="agreement-info">
                  ...
                  <p>
                    This extension respects your privacy. All data is stored
                    locally on your device. No personal information is collected
                    or transmitted to external servers unless you choose to use
                    OpenAI features with your own API key.
                  </p>
                  <div className="agreement-status-indicator">
                    <span
                      className={`status-badge ${settings.userAgreement.hasAgreed ? 'agreed' : 'pending'}`}
                    >
                      {settings.userAgreement.hasAgreed
                        ? 'Agreed'
                        : 'Pending Agreement'}
                    </span>
                    {settings.userAgreement.hasAgreed &&
                      settings.userAgreement.agreedAt && (
        ...
        <div className="settings-section">
          ...
          <div className="section-content">
            ...
            <p className="setting-description">
              Export your data for backup or import data from another
              installation.
            </p>
          </div>
        </div>
